...
export const FeedbackWidget = ({ showFeedback, toggleForm }) => {
  ...
  return (
    <>
      {showFeedback ? (
        <div
          className="popup flex w-full justify-center items-center bg-custom-blue-blue"
              ...
              <div
                className={`${
                  response === t("thankYouFeedback")
                    ...
                    : ""
                } text-white flex justify-between py-2 px-24 w-screen`}
              >
                <span className="text-xs lg:text-sm font-body mt-2 mb-4 flex justify-center w-full">
                  {response}
