  ...
  return (
    <nav>
      <div className="lg:container xxs:mx-0 xxs:px-0 lg:px-6 lg:mx-auto collapsible">
        <button id="button" className=" menuButton">
          <span className="mr-2">Menu</span> <span className="menuArrow"></span>
        </button>
      </div>

      <div className="content xl:container xl:mx-auto xl:px-6">
        <div id="menuContent">
          <ul className="border-solid border-2 border-gray-700" id="menuList">
            <li>
              <a
                tabIndex="0"
                className="collapsible topMenuItem  listItem cursor-pointer"
              >
              ...
              <ul className="content subListItem">
                ...
                <li className="mostRequestedList">
                  <a
                    tabIndex="-1"
                    className="collapsible listItem cursor-pointer"
                  >
                ...
                <li className="mostRequestedList">
                  ...
                  <ul className="content mostRequest">
                    <li className="listItem">
                      ...
                      >
                        COVID-19: Trade, foreign affairs, international trade
                        and development
                      </a>
                    </li>
                    <li className="listItem">
